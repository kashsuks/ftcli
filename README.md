...
- Cd into the directory where it was downloaded and then type `chmod -x <ftcli path>`
- Then type `./ftcli` and if your computer says that the app is not verified:
    - Go to privacy and security in Mac settings
    - Scroll down and look for allow ftcli to access
    - Allow
- Now type `./ftcli auth register`
    - You may also dm (@kashsuks) on the Hack Club Slack for test credentials
    - You will be prompted for information about you
- Once an account has been created type in `./ftcli`
    - Enter your username and password as prompted in the register section
